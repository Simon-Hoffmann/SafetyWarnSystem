...
**********************************************************/
//RFM66
const u8  C_RFM66_ModuleName[]={"66  "};
const u16 C_RFM66_FreqBuf[]={868,915,0};
const u8  C_RFM66_RateBuf[]={12,24,48,96,0};
const u8  C_RFM66_PowerBuf[]={20,17,14,11,0};
const u8  C_RFM66_FdevBuf[]={35,0};
const u8  C_RFM66_BandBuf[]={83,0};
const u8  C_RFM66_RSSIBuf[]={25,50,70,95,0};
const u8  C_RFM66_ModemBuf[]={C_SysMode_FSK,0};
