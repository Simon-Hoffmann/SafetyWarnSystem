...
{ 
  ...
  RF_ModemBuf=(u8*)C_RFM66_ModemBuf;
  if(RF_ModemBuf[gb_Modem_Addr]==C_SysMode_FSK)
  {
    RF_ModuleName=(u8*)C_RFM66_ModuleName; 
    RF_FreqBuf=(u16*)C_RFM66_FreqBuf;
    RF_RateBuf=(u8*)C_RFM66_RateBuf;
    RF_PowerBuf=(u8*)C_RFM66_PowerBuf;
    RF_FdevBuf=(u8*)C_RFM66_FdevBuf;
    RF_BandBuf=(u8*)C_RFM66_BandBuf;  
    RF_RSSIBuf=(u8*)C_RFM66_RSSIBuf;
  }
